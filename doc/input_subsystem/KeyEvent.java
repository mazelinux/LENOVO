...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    //zhangsx10 add new keys begin
    public static final int KEYCODE_PEN = 608;
    public static final int KEYCODE_NEXT = 609;
    public static final int KEYCODE_SAVE = 610;
    //zhangsx10 add new keys end
    public static final int KEYCODE_WLAN = 611;
    public static final int KEYCODE_APP_LIST = 612;
    public static final int KEYCODE_FUNCTION_LOCK = 613;
    public static final int KEYCODE_FLATKBD_SEARCH = 614;
    public static final int KEYCODE_FLATKBD_F1 = 701;
    public static final int KEYCODE_FLATKBD_F2 = 702;
    public static final int KEYCODE_FLATKBD_F3 = 703;
    public static final int KEYCODE_FLATKBD_F4 = 704;
    public static final int KEYCODE_FLATKBD_F5 = 705;
    public static final int KEYCODE_FLATKBD_F6 = 706;
    public static final int KEYCODE_FLATKBD_F7 = 707;
    public static final int KEYCODE_FLATKBD_F8 = 708;
    public static final int KEYCODE_FLATKBD_F9 = 709;
    public static final int KEYCODE_FLATKBD_F10 = 710;
    public static final int KEYCODE_FLATKBD_F11 = 711;
    public static final int KEYCODE_FLATKBD_F12 = 712;
    private static final int LAST_KEYCODE = KEYCODE_FLATKBD_F12;
    ...
    /**
     * <p>This mask is used to check whether the FUNCTION LOCK meta key is on.</p>
     *
     * @see #isFunctionLockOn()
     * @see #getMetaState()
     * @see #KEYCODE_FUNCTION_LOCK
     */
    public static final int META_FUNCTION_LOCK_ON = 0x800000;
    ...
    //Begin zhangsx10 add for smartpad keyboard
    public static final int FLAG_SMARTPAD_FLATKBD = 0x01000000;
    //End zhangsx10 add for smartpad keyboard
     ...
     * <p>
     * For the purposes of this function, {@link #KEYCODE_CAPS_LOCK},
     * {@link #KEYCODE_SCROLL_LOCK}, {@link #KEYCODE_NUM_LOCK}, and {@link #KEYCODE_FUNCTION_LOCK} are
     * not considered modifier keys.  Consequently, the mask specifically excludes
     * {@link #META_CAPS_LOCK_ON}, {@link #META_SCROLL_LOCK_ON}, {@link #META_NUM_LOCK_ON} and {@link #META_FUNCTION_LOCK_ON}.
     * </p>
     *
    ...
    public static boolean metaStateHasModifiers(int metaState, int modifiers) {
        ...
        if ((modifiers & META_INVALID_MODIFIER_MASK) != 0) {
            throw new IllegalArgumentException("modifiers must not contain "
                    + "META_CAPS_LOCK_ON, META_NUM_LOCK_ON, META_SCROLL_LOCK_ON, META_FUNCTION_LOCK_ON, "
    ...
    /**
     * <p>Returns the locked state of the FUNCTION LOCK meta key.</p>
     *
     * @return true if the FUNCTION LOCK key is on, false otherwise
     *
     * @see #KEYCODE_FUNCTION_LOCK
     * @see #META_FUNCTION_LOCK_ON
     */
    public final boolean isFunctionLockOn() {
        return (mMetaState & META_FUNCTION_LOCK_ON) != 0;
    }
